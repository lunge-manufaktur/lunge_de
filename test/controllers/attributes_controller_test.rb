...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { name: @attribute.name, product_id: @attribute.product_id, value: @attribute.value }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { name: @attribute.name, product_id: @attribute.product_id, value: @attribute.value }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
