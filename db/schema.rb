...
ActiveRecord::Schema.define(version: 20180316061313) do
  ...
  create_table "product_categorizations", id: :serial, force: :cascade do |t|
  ...
  create_table "store_images", id: :serial, force: :cascade do |t|
    t.integer "store_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "image_file_name", limit: 255
